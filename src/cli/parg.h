...
struct parg_state
{
	const wchar_t *optarg;   /**< Pointer to option argument, if any */
	int optind;              /**< Next index in argv to process */
	int optopt;              /**< Option value resulting in error, if any */
	const wchar_t *nextchar; /**< Next character to process */
};
 ...
 */
struct parg_option {
	const wchar_t *name; /**< Name of option */
 ...
 */
int
parg_reorder(int argc, wchar_t *argv[],
             const wchar_t *optstring,
